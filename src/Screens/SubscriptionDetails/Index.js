  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.text}>End Date : <Text style={{ color: '#000', fontFamily: 'Montserrat-Bold' }}>{moment(packageDetails?.subscription?.end_date).format('DD-MM-YYYY')}</Text></Text>
